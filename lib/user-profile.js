...
function userHasCompleteProfile(user) {
    ...
    return nameOk && phoneOk && telegramOk && priceOk && userHasPublicBodyVideo(user);
}

function getProfileIncompleteMessage() {
    return 'Completa tu perfil: nombre, ciudad, zona, teléfono, tarifa y video corporal público antes de publicar.';
}
